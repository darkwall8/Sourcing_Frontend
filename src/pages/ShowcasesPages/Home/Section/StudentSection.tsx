...
function StudentSection({ shouldAnimate }: { shouldAnimate: boolean }) {
    ...
    return (
        <div id="student" className="lg:h-[87vh] space-y-10 max-md:space-y-15 p-5">
            <div id="student_presentation" className="flex flex-col-reverse justify-center lg:space-x-50 gap-10 lg:flex-row">
                <div id="student_text" className={`flex flex-col gap-7 justify-center max-lg:items-center max-lg:m-auto lg:w-150 ${shouldAnimate ? 'lg:animate-fade-right' : ''}`}>
                    <div className="flex flex-col gap-7">
                        <p className="text-3xl lg:text-4xl font-bold"> {t("student.question")} </p>
                        <p className="text-xl lg:text-2xl"> {t("student.intro")} </p>
                    </div>
                    <div className="flex flex-col gap-7">
                ...
                <div className={`w-100 md:w-110 aspect-square max-lg:m-auto ${shouldAnimate ? 'lg:animate-fade-left' : ''}`}>
                    <img src={HomeStudent} alt="Company Image"/>
                </div>
            </div>
            <div id="student_comment" className={`flex max-md:flex-col justify-between m-auto w-full items-center gap-5 ${shouldAnimate ? 'xl:animate-fade-up' : ''}`}>
